...
setmetatable(_G, {
	...
	__newindex = function(self, k, v)
		...
		for i, sName in pairs(pACTN) do
			...
			-- LOOK INTO THIS!!!
			if sName == k then
				return --error(("Cannot override global table %s!"):format(k));
			end
			...
			if type(tbl) == "table" then
				...
				if _v then
					return --error(("Cannot override global constant %s!"):format(k));
				end
			end
		end
...
_DEFINE_GLOBAL_CONSTANT_TABLE("E_TraceLine", {
    ...
    SURF_SKY2D                    = 0x00000002;
    SURF_SKY                      = 0x00000004;
    SURF_WARP                     = 0x00000008;
    SURF_TRANS                    = 0x00000010;
    SURF_NOPORTAL                 = 0x00000020;
    SURF_TRIGGER                  = 0x00000040;
    SURF_NODRAW                   = 0x00000080;
    SURF_HINT                     = 0x00000100;
    SURF_SKIP                     = 0x00000200;
    SURF_NOLIGHT                  = 0x00000400;
    SURF_BUMPLIGHT                = 0x00000800;
    SURF_NOSHADOWS                = 0x00001000;
    SURF_NODECALS                 = 0x00002000;
    SURF_NOPAINT                  = 0x00002000;
    SURF_NOCHOP                   = 0x00004000;
    SURF_HITBOX                   = 0x00008000;
    MASK_ALL                      = 0xFFFFFFFF;
    MASK_SOLID                    = 0x0200400B;      -- (CONTENTS_SOLID|CONTENTS_MOVEABLE|CONTENTS_WINDOW|CONTENTS_MONSTER|CONTENTS_GRATE)
    MASK_PLAYERSOLID              = 0x0201400B;      -- (CONTENTS_SOLID|CONTENTS_MOVEABLE|CONTENTS_PLAYERCLIP|CONTENTS_WINDOW|CONTENTS_MONSTER|CONTENTS_GRATE)
    MASK_NPCSOLID                 = 0x0202400B;      -- (CONTENTS_SOLID|CONTENTS_MOVEABLE|CONTENTS_MONSTERCLIP|CONTENTS_WINDOW|CONTENTS_MONSTER|CONTENTS_GRATE)
    MASK_NPCFLUID                 = 0x02024003;      -- (CONTENTS_SOLID|CONTENTS_MOVEABLE|CONTENTS_MONSTERCLIP|CONTENTS_WINDOW|CONTENTS_MONSTER)
    MASK_WATER                    = 0x00004030;      -- (CONTENTS_WATER|CONTENTS_MOVEABLE|CONTENTS_SLIME)
    MASK_OPAQUE                   = 0x00004081;      -- (CONTENTS_SOLID|CONTENTS_MOVEABLE|CONTENTS_OPAQUE)
    MASK_OPAQUE_AND_NPCS          = 0x02004081;      -- (MASK_OPAQUE|CONTENTS_MONSTER)
    MASK_BLOCKLOS                 = 0x00004041;      -- (CONTENTS_SOLID|CONTENTS_MOVEABLE|CONTENTS_BLOCKLOS)
    MASK_BLOCKLOS_AND_NPCS        = 0x02004041;      -- (MASK_BLOCKLOS|CONTENTS_MONSTER)
    MASK_VISIBLE                  = 0x00006081;      -- (MASK_OPAQUE|CONTENTS_IGNORE_NODRAW_OPAQUE)
    MASK_VISIBLE_AND_NPCS         = 0x02006081;      -- (MASK_OPAQUE_AND_NPCS|CONTENTS_IGNORE_NODRAW_OPAQUE)
    MASK_SHOT                     = 0x46004003;      -- (CONTENTS_SOLID|CONTENTS_MOVEABLE|CONTENTS_MONSTER|CONTENTS_WINDOW|CONTENTS_DEBRIS|CONTENTS_HITBOX)
    MASK_SHOT_BRUSHONLY           = 0x04004003;      -- (CONTENTS_SOLID|CONTENTS_MOVEABLE|CONTENTS_WINDOW|CONTENTS_DEBRIS)
    MASK_SHOT_HULL                = 0x0600400B;      -- (CONTENTS_SOLID|CONTENTS_MOVEABLE|CONTENTS_MONSTER|CONTENTS_WINDOW|CONTENTS_DEBRIS|CONTENTS_GRATE)
    MASK_SHOT_PORTAL              = 0x02004003;      -- (CONTENTS_SOLID|CONTENTS_MOVEABLE|CONTENTS_WINDOW|CONTENTS_MONSTER)
    MASK_SOLID_BRUSHONLY          = 0x0000400B;      -- (CONTENTS_SOLID|CONTENTS_MOVEABLE|CONTENTS_WINDOW|CONTENTS_GRATE)
    MASK_PLAYERSOLID_BRUSHONLY    = 0x0001400B;      -- (CONTENTS_SOLID|CONTENTS_MOVEABLE|CONTENTS_WINDOW|CONTENTS_PLAYERCLIP|CONTENTS_GRATE)
    MASK_NPCSOLID_BRUSHONLY       = 0x0002400B;      -- (CONTENTS_SOLID|CONTENTS_MOVEABLE|CONTENTS_WINDOW|CONTENTS_MONSTERCLIP|CONTENTS_GRATE)
    MASK_NPCWORLDSTATIC           = 0x0002000B;      -- (CONTENTS_SOLID|CONTENTS_WINDOW|CONTENTS_MONSTERCLIP|CONTENTS_GRATE)
    MASK_NPCWORLDSTATIC_FLUID     = 0x00020003;      -- (CONTENTS_SOLID|CONTENTS_WINDOW|CONTENTS_MONSTERCLIP)
    MASK_SPLITAREAPORTAL          = 0x00000030;      -- (CONTENTS_WATER|CONTENTS_SLIME)
    MASK_CURRENT                  = 0x00FC0000;      -- (CONTENTS_CURRENT_0|CONTENTS_CURRENT_90|CONTENTS_CURRENT_180|CONTENTS_CURRENT_270|CONTENTS_CURRENT_UP|CONTENTS_CURRENT_DOWN)
    MASK_DEADSOLID                = 0x0001000B;      -- (CONTENTS_SOLID|CONTENTS_PLAYERCLIP|CONTENTS_WINDOW|CONTENTS_GRATE)
    MAX_COORD_INTEGER             = 0x00004000;
    COORD_EXTENT                  = 0x00008000;      -- (2*MAX_COORD_INTEGER)
    MAX_TRACE_LENGTH              = 56755.840862421; -- (1.732050807569*COORD_EXTENT)
});
